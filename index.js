import SubCliteLexer from "./generated/SubCliteLexer.js";
import SubCliteParser from "./generated/SubCliteParser.js";
import { CustomSubCliteListener } from "./CustomSubCliteListener.js";
import { CustomSubCliteVisitor } from "./CustomSubCliteVisitor.js";
...
async function main() {
    ...
    let lexer = new SubCliteLexer(inputStream);
    let tokenStream = new CommonTokenStream(lexer);
    let parser = new SubCliteParser(tokenStream);
    ...
    if (parser.syntaxErrorsCount > 0) {
        ...
        const visitor = new CustomSubCliteVisitor();
        visitor.visit(tree);   
    }
}
