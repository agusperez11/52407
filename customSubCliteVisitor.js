...
import SubCliteVisitor from "./generated/SubCliteVisitor.js";
import SubCliteParser from "./generated/SubCliteParser.js";

export class CustomSubCliteVisitor extends SubCliteVisitor{
    ...
    visitMulDiv(ctx) {
        ...
        if (ctx.op.type==SubCliteParser.MUL)
          return left * right;
        else
          return left / right;
      }
      ...
      visitAddSub(ctx) {
        ...
        if (ctx.op.type==SubCliteParser.ADD){
          return left + right; }
        else
          return left - right;
      }
